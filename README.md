...
```bash
curl -X POST https://example.com/api/v1/sessions/execute \
  -H "Authorization: Bearer YOUR_ACCESS_TOKEN" \
  -H "Content-Type: application/json" \
  -d '{
    "command": "nmap",
...
```bash
curl -X GET https://example.com/api/v1/sessions/{session_id} \
  -H "Authorization: Bearer YOUR_ACCESS_TOKEN"
```
...
```bash
curl -X GET "https://example.com/api/v1/sessions?skip=0&limit=50" \
  -H "Authorization: Bearer YOUR_ACCESS_TOKEN"
```
...
```bash
curl -X GET https://example.com/api/v1/instance/status \
  -H "Authorization: Bearer YOUR_ACCESS_TOKEN"
```
...
```bash
curl -X GET https://example.com/api/v1/instance/info \
  -H "Authorization: Bearer YOUR_ACCESS_TOKEN"
```
...
# Instance metrics
curl https://example.com/api/v1/instance/status \
